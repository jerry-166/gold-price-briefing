...
| BUG-003 | 金价早报调度器异常（9/6-9/7缺跑；9/13-9/26连续延迟7-88分钟；**9/23整日完全缺跑**；9/25延迟35、9/26延迟69分钟） | major | open |
...
| BUG-012 | 巡检定时任务连续七日缺跑（9/18-9/24），且「晚间巡检」9/25、9/26 连续两日提前约12小时触发 | major | open |
| BUG-013 | Buglog hook 把自动化任务提示词误判为「用户报告的 bug」，会污染 buglog | minor | open |
